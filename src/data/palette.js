...
const COLOR_THEMES = [
  ...
  { id:'rose',    name:'ばら',       emoji:'🌹',
    ...
    lavender:'#9b89c4' },
  { id:'white',   name:'くりーむ',   emoji:'🤍',
    amber:'#EDE8DC', amberLight:'#F5F1EA', amberPale:'#FDFCF8',
    teal:'#E2EEF0',  tealLight:'#EEF6F8',
    coral:'#F0E8E4', coralLight:'#F7F1EE',
    mint:'#E6F0E8',  mintLight:'#F0F7F2',
    deep:'#2c2016',  paper:'#FFFEF6', paper2:'#F2EEE0',
    lavender:'#EAE6F4' },
  { id:'black',   name:'グレー',     emoji:'🩶',
    amber:'#8890a8', amberLight:'#aab0c4', amberPale:'#52565a',
    teal:'#5a9aaa',  tealLight:'#88bec8',
    coral:'#a87878', coralLight:'#c8a0a0',
    mint:'#609878',  mintLight:'#90c0a0',
    deep:'#eceef0',  paper:'#72777B', paper2:'#686C70',
    lavender:'#9888b8' },
];
